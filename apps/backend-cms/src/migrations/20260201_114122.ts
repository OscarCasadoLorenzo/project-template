...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "positions" ADD CONSTRAINT "positions_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "positions_company_idx" ON "positions" USING btree ("company");
  CREATE INDEX "positions_logo_idx" ON "positions" USING btree ("logo_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "positions_highlights" CASCADE;
